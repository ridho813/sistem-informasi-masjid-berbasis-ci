                  ...
                  <table class="table table-bordered table-md">
                    ...
                    <?php foreach($kas_masjid as $k) : ?>
										<tr>
											...
											<td><?= $k['pemasukan']; ?></td>
											<td><?= $k['pengeluaran']; ?></td>
											<td><?= $k['pemasukan']-$k['pengeluaran']; ?></td>
											<td><?= $k['keterangan']; ?></td>
											<td>
                        <img src="<?= base_url('assets/infaq/') . $k['foto']; ?>" width="80">           
											...
											<td><?= $k['keterangan']; ?></td>
                      <td>
                        <button type="button" class="btn btn-info formModalUbahArtikel" data-toggle="modal" data-target="#formModalKategori" data-id="<?= $k['id_transaksi']; ?>"><i class="fas fa-edit"></i></button>
