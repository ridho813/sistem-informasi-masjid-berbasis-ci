            ...
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-4 ml-4">
                  <form action="<?= base_url('back_end/tausiyah'); ?>" method="post">
                  ...
                  <table class="table table-bordered table-md">
                    ...
                    <?php foreach($tb_kegiatan as $k) : ?>
										<tr>
											...
											<td><?= $k['jam_selesai']; ?></td>
											<td>
                        <img src="<?= base_url('assets/kegiatan/') . $k['foto']; ?>" width="80">           
                      </td>
											<td><?= $k['keterangan']; ?></td>
                      <td>
											<a href="<?= base_url('back_end/tausiyah/ubahartikel/') . $k['id_kegiatan']; ?>"  class="btn btn-edit"><i class="fas fa-edit"></i></a>
                        <a href="<?= base_url('back_end/tausiyah/hapus/') . $k['id_kegiatan']; ?>" onclick="return confirm('Yakin ?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
										</tr>
                    <?php endforeach; ?>
                  </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabel">Tambah Data Kegiatan</h5>
	  ...
	  <form action="" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group">
            <label for="kategori">Narasumber</label>
            ...
            <input type="text" name="judul_kegiatan" id="judul_kegiatan" class="form-control  " onkeyup="createTextSlug()">
            <small class="muted text-danger"><?= form_error('judul_kegiatan'); ?></small>
          </div>
						<div class="form-group">
            <label for="judul">Slug Kegiatan</label>
		  ...
		  <div class="form-group">
            <label for="judul">Jam Mulai</label>
            <input type="time" name="jam_mulai" id="jam_mulai" class="form-control">
            <small class="muted text-danger"><?= form_error('jam_mulai'); ?></small>
          </div>
		  <div class="form-group">
            <label for="judul">jam selesai</label>
            <input type="time" name="jam_selesai" id="jam_selesai" class="form-control">
            <small class="muted text-danger"><?= form_error('jam_selesai'); ?></small>
          </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
            <label for="foto">Gambar</label>perhatikan nama tidak boleh mengandung spas<br>
...
<script>
    ...
    {
        var title = document.getElementById("judul_kegiatan").value;
