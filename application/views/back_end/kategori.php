            ...
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-4 ml-4">
                  <form action="<?= base_url('back_end/kategori'); ?>" method="post">
                  ...
                  <table class="table table-bordered table-md">
                    ...
                    <?php foreach($kategori as $k) : ?>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('back_end/kategori/hapus/') . $k['id_kategori']; ?>" onclick="return confirm('Yakin ?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
										</tr>
                    <?php endforeach; ?>
                  </table>
