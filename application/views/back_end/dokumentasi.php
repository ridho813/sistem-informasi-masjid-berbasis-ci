            ...
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-4 ml-4">
                  <form action="<?= base_url('back_end/galery'); ?>" method="post">
              ...
              <div class="row">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-md">
                    ...
                    <?php endif; ?>
                    <?php foreach($tb_dokumentasi as $k) : ?>
										<tr>
											<td><?= ++$start; ?></td>
											...
											<td>
                        <img src="<?= base_url('assets/galery/') . $k['file_dokumentasi']; ?>" width="80">           
                      </td>
											<td><?= $k['keterangan']; ?></td>
                      <td>
