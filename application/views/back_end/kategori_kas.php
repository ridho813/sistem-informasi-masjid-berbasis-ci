                  ...
                  <table class="table table-bordered table-md">
                    ...
                    <?php foreach($kategori_kas as $k) : ?>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('back_end/kategori_kas/hapus/') . $k['id_kategori']; ?>" onclick="return confirm('Yakin ?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
										</tr>
                    <?php endforeach; ?>
                  </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="formModalLabel">Tambah Data Kategori Kas</h5>
